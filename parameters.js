...
// config.MONGO_DB_GERAL = "tGeralPad";
config.MONGO_DB_GERAL = "metadata2";
config.MONGO_DB_THEMES = "tThemes";
config.MONGO_DB_QUEUE = "tQueueTemp";
...
config.APP_AUX_FILES_FOLDER = '/datacem/output/IBGE/';
// Downloads in Apache folder
// config.APP_CENSO_MANUAL_FILES_FOLDER = '/datacem/output/downloads/';
config.APP_CENSO_MANUAL_FILES_FOLDER = '/downloads/IBGE/';
config.QUEUE_CHECK_INTERVAL_SECONDS = 3
config.MAX_CONCURRENT_PROCCESS = 2
// Tempo de sessão, em minutos
config.SESSION_TIME_MINUTES = 30
